    ...
    public:
        ...
        int32_t Read(T* buffer, int32_t count) {
            ...
            if (_pos + sizeToRead > _buffer.size()) {
                sizeToRead = static_cast<int32_t>(_buffer.size()) - _pos;
            }

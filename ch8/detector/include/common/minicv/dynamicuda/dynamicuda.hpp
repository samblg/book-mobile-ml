...
public:
    ...
    virtual void setTo(minicv::gpu::GpuMat&, minicv::Scalar, const minicv::gpu::GpuMat&, cudaStream_t) const = 0;
...
public:
    ...
    virtual void setTo(minicv::gpu::GpuMat&, minicv::Scalar, const minicv::gpu::GpuMat&, cudaStream_t) const { throw_nogpu; }
...
{
    if (cudaSuccess != err)
        minicv::gpu::error(cudaGetErrorString(err), file, line, func);
}
...
inline void ___nppSafeCall(int err, const char *file, const int line, const char *func = "")
{
    if (err < 0)
    {
        ...
        minicv::gpu::error(msg.str().c_str(), file, line, func);
    }
}

#endif

namespace minicv { namespace gpu { namespace device
{
...
{
    Scalar_<T> sf = s;
    minicv::gpu::device::set_to_gpu(src, sf.val, src.channels(), stream);
}

template <typename T> void kernelSetCaller(GpuMat& src, Scalar s, const GpuMat& mask, cudaStream_t stream)
{
    Scalar_<T> sf = s;
    minicv::gpu::device::set_to_gpu(src, sf.val, mask, src.channels(), stream);
}
...
namespace minicv { namespace gpu { namespace device
{
    ...
    void copyWithMask(const GpuMat& src, GpuMat& dst, const GpuMat& mask, cudaStream_t stream)
    {
        ...
        minicv::gpu::device::copyToWithMask_gpu(src.reshape(1), dst.reshape(1), src.elemSize1(), src.channels(), mask.reshape(1), mask.channels() != 1, stream);
    }

    void convertTo(const GpuMat& src, GpuMat& dst)
    {
        minicv::gpu::device::convert_gpu(src.reshape(1), src.depth(), dst.reshape(1), dst.depth(), 1.0, 0.0, 0);
    }

    void convertTo(const GpuMat& src, GpuMat& dst, double alpha, double beta, cudaStream_t stream)
    {
        minicv::gpu::device::convert_gpu(src.reshape(1), src.depth(), dst.reshape(1), dst.depth(), alpha, beta, stream);
    }
...
public:
    ...
    void copyWithMask(const GpuMat& src, GpuMat& dst, const GpuMat& mask) const
    {
        ...
        {
            /*  8U */ {NppCopyMasked<CV_8U , nppiCopy_8u_C1MR >::call, minicv::gpu::device::copyWithMask, NppCopyMasked<CV_8U , nppiCopy_8u_C3MR >::call, NppCopyMasked<CV_8U , nppiCopy_8u_C4MR >::call},
            /*  8S */ {minicv::gpu::device::copyWithMask                ,  minicv::gpu::device::copyWithMask, minicv::gpu::device::copyWithMask                 , minicv::gpu::device::copyWithMask                         },
            /* 16U */ {NppCopyMasked<CV_16U, nppiCopy_16u_C1MR>::call, minicv::gpu::device::copyWithMask, NppCopyMasked<CV_16U, nppiCopy_16u_C3MR>::call, NppCopyMasked<CV_16U, nppiCopy_16u_C4MR>::call},
            /* 16S */ {NppCopyMasked<CV_16S, nppiCopy_16s_C1MR>::call, minicv::gpu::device::copyWithMask, NppCopyMasked<CV_16S, nppiCopy_16s_C3MR>::call, NppCopyMasked<CV_16S, nppiCopy_16s_C4MR>::call},
            /* 32S */ {NppCopyMasked<CV_32S, nppiCopy_32s_C1MR>::call, minicv::gpu::device::copyWithMask, NppCopyMasked<CV_32S, nppiCopy_32s_C3MR>::call, NppCopyMasked<CV_32S, nppiCopy_32s_C4MR>::call},
            /* 32F */ {NppCopyMasked<CV_32F, nppiCopy_32f_C1MR>::call, minicv::gpu::device::copyWithMask, NppCopyMasked<CV_32F, nppiCopy_32f_C3MR>::call, NppCopyMasked<CV_32F, nppiCopy_32f_C4MR>::call},
            /* 64F */ {minicv::gpu::device::copyWithMask                ,  minicv::gpu::device::copyWithMask, minicv::gpu::device::copyWithMask                 , minicv::gpu::device::copyWithMask                         }
         };

         const func_t func =  mask.channels() == src.channels() ? funcs[src.depth()][src.channels() - 1] : minicv::gpu::device::copyWithMask;
#else
        const func_t func = minicv::gpu::device::copyWithMask;
#endif
    ...
    void convert(const GpuMat& src, GpuMat& dst) const
    {
        ...
        static const func_t funcs[7][7][4] =
        {
            {
                /*  8U ->  8U */ {0, 0, 0, 0},
                /*  8U ->  8S */ {minicv::gpu::device::convertTo                        , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /*  8U -> 16U */ {NppCvt<CV_8U, CV_16U, nppiConvert_8u16u_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, NppCvt<CV_8U, CV_16U, nppiConvert_8u16u_C4R>::call},
                /*  8U -> 16S */ {NppCvt<CV_8U, CV_16S, nppiConvert_8u16s_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, NppCvt<CV_8U, CV_16S, nppiConvert_8u16s_C4R>::call},
                /*  8U -> 32S */ {minicv::gpu::device::convertTo                        , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /*  8U -> 32F */ {NppCvt<CV_8U, CV_32F, nppiConvert_8u32f_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /*  8U -> 64F */ {minicv::gpu::device::convertTo                        , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                }
            },
            {
                /*  8S ->  8U */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /*  8S ->  8S */ {0,0,0,0},
                /*  8S -> 16U */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /*  8S -> 16S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /*  8S -> 32S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /*  8S -> 32F */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /*  8S -> 64F */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo}
            },
            {
                /* 16U ->  8U */ {NppCvt<CV_16U, CV_8U , nppiConvert_16u8u_C1R >::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, NppCvt<CV_16U, CV_8U, nppiConvert_16u8u_C4R>::call},
                /* 16U ->  8S */ {minicv::gpu::device::convertTo                                  , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16U -> 16U */ {0,0,0,0},
                /* 16U -> 16S */ {minicv::gpu::device::convertTo                                  , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16U -> 32S */ {NppCvt<CV_16U, CV_32S, nppiConvert_16u32s_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16U -> 32F */ {NppCvt<CV_16U, CV_32F, nppiConvert_16u32f_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16U -> 64F */ {minicv::gpu::device::convertTo                                  , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                }
            },
            {
                /* 16S ->  8U */ {NppCvt<CV_16S, CV_8U , nppiConvert_16s8u_C1R >::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, NppCvt<CV_16S, CV_8U, nppiConvert_16s8u_C4R>::call},
                /* 16S ->  8S */ {minicv::gpu::device::convertTo                                  , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16S -> 16U */ {minicv::gpu::device::convertTo                                  , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16S -> 16S */ {0,0,0,0},
                /* 16S -> 32S */ {NppCvt<CV_16S, CV_32S, nppiConvert_16s32s_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16S -> 32F */ {NppCvt<CV_16S, CV_32F, nppiConvert_16s32f_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                },
                /* 16S -> 64F */ {minicv::gpu::device::convertTo                                  , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo                                }
            },
            {
                /* 32S ->  8U */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32S ->  8S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32S -> 16U */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32S -> 16S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32S -> 32S */ {0,0,0,0},
                /* 32S -> 32F */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32S -> 64F */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo}
            },
            {
                /* 32F ->  8U */ {NppCvt<CV_32F, CV_8U , nppiConvert_32f8u_C1R >::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32F ->  8S */ {minicv::gpu::device::convertTo                          , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32F -> 16U */ {NppCvt<CV_32F, CV_16U, nppiConvert_32f16u_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32F -> 16S */ {NppCvt<CV_32F, CV_16S, nppiConvert_32f16s_C1R>::call, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32F -> 32S */ {minicv::gpu::device::convertTo                          , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 32F -> 32F */ {0,0,0,0},
                /* 32F -> 64F */ {minicv::gpu::device::convertTo                          , minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo}
            },
            {
                /* 64F ->  8U */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 64F ->  8S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 64F -> 16U */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 64F -> 16S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 64F -> 32S */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 64F -> 32F */ {minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo, minicv::gpu::device::convertTo},
                /* 64F -> 64F */ {0,0,0,0}
            }
        };
#endif
        ...
        if (!aligned)
        {
            minicv::gpu::device::convertTo(src, dst);
            return;
        }
        ...
        CV_DbgAssert(func != 0);
#else
        const func_t func = minicv::gpu::device::convertTo;
#endif
    ...
    void convert(const GpuMat& src, GpuMat& dst, double alpha, double beta, cudaStream_t stream) const
    {
        ...
        minicv::gpu::device::convertTo(src, dst, alpha, beta, stream);
    }
    ...
    void setTo(GpuMat& m, Scalar s, const GpuMat& mask, cudaStream_t stream) const
    {
        if (mask.empty())
        {
            ...
            static const func_t funcs[7][4] =
            {
                {NppSet<CV_8U , 1, nppiSet_8u_C1R >::call, minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                        , NppSet<CV_8U , 4, nppiSet_8u_C4R >::call},
                {minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                        , minicv::gpu::device::setTo                          },
                {NppSet<CV_16U, 1, nppiSet_16u_C1R>::call, NppSet<CV_16U, 2, nppiSet_16u_C2R>::call, minicv::gpu::device::setTo                        , NppSet<CV_16U, 4, nppiSet_16u_C4R>::call},
                {NppSet<CV_16S, 1, nppiSet_16s_C1R>::call, NppSet<CV_16S, 2, nppiSet_16s_C2R>::call, minicv::gpu::device::setTo                        , NppSet<CV_16S, 4, nppiSet_16s_C4R>::call},
                {NppSet<CV_32S, 1, nppiSet_32s_C1R>::call, minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                        , NppSet<CV_32S, 4, nppiSet_32s_C4R>::call},
                {NppSet<CV_32F, 1, nppiSet_32f_C1R>::call, minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                        , NppSet<CV_32F, 4, nppiSet_32f_C4R>::call},
                {minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                  , minicv::gpu::device::setTo                        , minicv::gpu::device::setTo                          }
            };
#endif
...
#else
        const func_t func = minicv::gpu::device::setTo;
#endif

            if (stream)
                minicv::gpu::device::setTo(m, s, stream);
            else
                func(m, s);
        }
        else
        {
            ...
            static const func_t funcs[7][4] =
            {
                {NppSetMask<CV_8U , 1, nppiSet_8u_C1MR >::call, minicv::gpu::device::setTo, minicv::gpu::device::setTo, NppSetMask<CV_8U , 4, nppiSet_8u_C4MR >::call},
                {minicv::gpu::device::setTo                       , minicv::gpu::device::setTo, minicv::gpu::device::setTo, minicv::gpu::device::setTo                               },
                {NppSetMask<CV_16U, 1, nppiSet_16u_C1MR>::call, minicv::gpu::device::setTo, minicv::gpu::device::setTo, NppSetMask<CV_16U, 4, nppiSet_16u_C4MR>::call},
                {NppSetMask<CV_16S, 1, nppiSet_16s_C1MR>::call, minicv::gpu::device::setTo, minicv::gpu::device::setTo, NppSetMask<CV_16S, 4, nppiSet_16s_C4MR>::call},
                {NppSetMask<CV_32S, 1, nppiSet_32s_C1MR>::call, minicv::gpu::device::setTo, minicv::gpu::device::setTo, NppSetMask<CV_32S, 4, nppiSet_32s_C4MR>::call},
                {NppSetMask<CV_32F, 1, nppiSet_32f_C1MR>::call, minicv::gpu::device::setTo, minicv::gpu::device::setTo, NppSetMask<CV_32F, 4, nppiSet_32f_C4MR>::call},
                {minicv::gpu::device::setTo                       , minicv::gpu::device::setTo, minicv::gpu::device::setTo, minicv::gpu::device::setTo                               }
            };
#endif
        ...
        const func_t func = minicv::gpu::device::setTo;
            ...
            if (stream)
                minicv::gpu::device::setTo(m, s, mask, stream);
            else
                func(m, s, mask);
        }
    }
